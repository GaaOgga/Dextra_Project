/**
 * DEKSTRA PARFUME - Data & Content Configuration
 * Edit konten, teks, dan produk di file ini tanpa perlu mengubah struktur HTML.
 */

const BRAND_DATA = {
  name: "DEKSTRA PARFUME",
  tagline: "Wangi Mewah, Nggak Bikin Dompet Menangis.",
  heroHeading: "Temukan Arah Wangimu Bersama DEKSTRA.",
  heroSubheadline: "Parfum kualitas premium dengan racikan otentik yang siap nemenin aktivitas seharian kamu. Tahan lama, elegan, dan tetep ramah di kantong!",
  whatsappNumber: "6281234567890", // Ganti dengan nomor WA aktif (format 62...)
...
const PRODUCTS = [
  {
    ...
    description: "Kombinasi kehangatan senja yang manis dan menenangkan. Cocok buat kamu yang mau tampil standout saat hang out malam hari.",
    badge: "Best Seller"
  },
  {
    id: 2,
    ...
    description: "Aroma bunga segar yang feminin tanpa terkesan berlebihan. Bikin vibe ngantor atau ngampus kamu makin fresh seharian.",
    badge: "Favorite"
  },
  {
    id: 3,
    ...
    description: "Karakter kayu yang hangat dan bold. Pilihan pas buat cowok yang pengen tampil karismatik tapi tetep santai.",
    badge: "New"
  },
  {
    id: 4,
    ...
    description: "Sensasi kesegaran angin laut di pagi hari. Pas banget buat nemenin kamu habis workout atau aktivitas outdoor.",
    badge: null
  },
  {
    id: 5,
    ...
    description: "Perpaduan unik rasa pahit-manis matcha khas cafe kekinian. Bikin siapa pun di deket kamu auto nanya 'pakai parfum apa?'",
    badge: "Trending"
  },
  {
    id: 6,
    ...
    description: "Aroma misterius dan mewah yang pas banget buat nge-date atau dinner formal. Bikin gebetan nggak mau jauh-jauh!",
    badge: null
  }
];
...
const TESTIMONIALS = [
  {
    ...
    name: "Rian Hidayat",
    role: "Mahasiswa",
    comment: "Sumpah Matcha Serenade-nya dapet banget aromanya! Ketahanan di baju gue bisa sampe besoknya. Wajib repeat order sih ini.",
  ...
  },
  {
    ...
    comment: "Packaging-nya estetik banget buat dipajang di mejasias. Wangi Aura Sunset bikin nagih, lembut tapi tetep berkelas!",
  ...
  },
  {
    ...
    name: "Dimas Anggara",
    role: "Freelancer",
    comment: "Awalnya skeptis karena harganya terjangkau, pas nyoba Velvet Cedar... wah gilak, berasa parfum jutaan!",
